...
- **Pin board:** Online-only collaborative notepad per group (`pin_boards` PostgREST). **Not** in Room or [SyncInteractor](app/src/main/java/com/splitease/app/data/sync/SyncInteractor.kt); load/save via [PinBoardInteractor](app/src/main/java/com/splitease/app/data/pinboard/PinBoardInteractor.kt) on explicit Save. See [PinBoardPolicy](app/src/main/java/com/splitease/app/data/pinboard/PinBoardPolicy.kt).
