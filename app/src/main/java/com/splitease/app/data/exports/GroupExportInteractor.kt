...
/**
 * Loads a group's expenses and payments, then renders a CSV export.
 */
@Singleton
class GroupExportInteractor
    ...
    constructor(
        ...
        /**
         * Builds a CSV of expenses and payments for [groupId].
         *
         * @param groupId Group to export.
         * @param viewerUserId Signed-in member (used for friend display names).
