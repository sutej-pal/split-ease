...
- Invite email is sent for email contacts via mail-service; phone + generic share links still use the share sheet. Install Referrer E2E needs a Play install
