...
| 100+ currencies                     | **7**                                                    | Partial (~30 ISO in `AppCurrencies`) |
...
**Covers:** Offline mode · Cloud sync · Spending totals · Categorize expenses · Currencies (~30 ISO)  
...
| Currency catalog (~30 ISO in `AppCurrencies`), per-expense picker + FX snapshot | 100+ ISO list still open |
